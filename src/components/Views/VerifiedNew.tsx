...
const VerifiedNew: React.FC<VerifiedProps> = ({
  route,
  navigation,
}: VerifiedProps) => {
        ...
        >
          <View>
            {result?.statusCode !== 200  ? (
              ...
              <>
              {(() => { soundRelease(); return null; })()}
              <View>
                <View style={[{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: '18%'}]}>
                  <Image 
